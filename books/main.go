...
func create(req events.APIGatewayProxyRequest) (events.APIGatewayProxyResponse, error) {
	//debugLogger.Println("Headers: ", req.Headers)
	//debugLogger.Println("HTTPMethod: ", req.HTTPMethod)
	//debugLogger.Println("Path: ", req.Path)
	//debugLogger.Println("Body: ", req.Body)
	// Case sensitive map. Yuk! TODO
